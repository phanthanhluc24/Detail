var product = [{
    ...
    img: 'https://media3.scdn.vn/img4/2021/01_07/OfE7MT7k9F5JBNERCyOp.jpg',
    price: 122000,
    },
    {
    id: 'SP2',
  ...
  listproduct +='<span class="text-center add-to-cart btn btn-outline-warning add-cart" data-id="' +data.id +" data-name=" +data.name +" data-img=" +data.img +" data-price=" +	data.price +'" onclick="tks()">';
  listproduct += '<a>';
  listproduct += '<button class="btn btn-secondary" data-toggle="modal" data-target="#proDetails" onclick="proDetail('+i+')">Detail</button>';listproduct += '</a>';listproduct += '</span>';
  listproduct += '</div>';
  listproduct += '</div>';
